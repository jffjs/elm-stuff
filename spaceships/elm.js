...
Elm.Spacehips = Elm.Spacehips || {};
Elm.Spacehips.make = function (_elm) {
   "use strict";
   _elm.Spacehips = _elm.Spacehips || {};
   if (_elm.Spacehips.values) return _elm.Spacehips.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = $Graphics$Element.show("Hello");
   return _elm.Spacehips.values = {_op: _op,main: main};
};
